...
public class classPrep extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedColorId != -1 && selectedTimeId != -1 && selectedPoorStudyId != -1 &&
                    ...
                    Toast.makeText(classPrep.this, "Impact survey submitted successfully!", Toast.LENGTH_SHORT).show();
                    goToPAGE();
                } else {
                    // Display an error message if not all questions are answered
                    Toast.makeText(classPrep.this, "Please answer all questions", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void goToPAGE(){
        Intent PAGE = new Intent(this, SurveyPage19.class);
        startActivity(PAGE);
